...
{  
	...
	row+='<td><div><input type="text" id="stkqty_'+count+'" name="stkqty_'+count+'" class="form-control onlynumval cal-inp" placeholder="Quantity" required  autocomplete="off"/></div></td>';
...
function resetSeq()
{
	...
	$('#netamt').html(finaltotal);
	$('#bkpnetamt').val(finaltotal);
}
