...
function srchSale()
{
    var formdata=$('#srchsale_form').serialize();    
    $('#sale_table').html("<tr><td colspan='13' class='cen'><img src='" + base_url +"assets/images/loader/circle.gif' /></td></tr>");

    $.ajax({
        type:'POST',
        url:base_url + 'INVENTORY/srchSale',
        data:formdata,
