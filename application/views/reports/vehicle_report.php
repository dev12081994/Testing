		...
		<div class="panel-body">
			<form name="srchvrun_form" id="srchvrun_form" method="post" action="<?php echo base_url(); ?>REPORTS/exportVehicleRep">				
				<div class="row form-group">
					...
					<div class="col-md-2">
						<input type="text" id="srch_fdate" name="srch_fdate" class="form-control mydatepicker" placeholder="From Date"  autocomplete="off"/>
					</div>

					<div class="col-md-2">
						<input type="text" id="srch_tdate" name="srch_tdate" class="form-control mydatepicker" placeholder="To Date"  autocomplete="off"/>
					</div>
