                        ...
                        <div class="row form-group">
						 ...
						 <div class="row form-group">
                            <div class="form-group col-lg-2">
                                <input type="text" name="srch_ftdate" id="srch_ftdate" class="form-control mydatepicker" placeholder="From Expense Date"  autocomplete="off">                                     
                             </div>

                            <div class="form-group col-lg-2">
                                <input type="text" name="srch_ttdate" id="srch_ttdate" class="form-control mydatepicker" placeholder="To Expense Date"  autocomplete="off">                                     
                            </div>
                            
                            <div class="form-group col-lg-2">
                                <input type="text" name="srch_fedate" id="srch_fedate" class="form-control mydatepicker" placeholder="From Entry Date"  autocomplete="off">                                     
                             </div>

                            <div class="form-group col-lg-2">
                                <input type="text" name="srch_tedate" id="srch_tedate" class="form-control mydatepicker" placeholder="To Entry Date"  autocomplete="off">                                     
                            </div>
