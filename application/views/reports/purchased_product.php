				...
				<div class="panel-body">
				 	<form method="post" id="srchpurchase_form" action="<?php echo base_url(); ?>REPORTS/exportPurchasedProduct">                               
                        <div class="row">
                            ...
                            <div class="form-group col-lg-2">
                                <input type="text" name="srch_fdate" id="srch_fdate" class="form-control mydatepicker" placeholder="From Date"  autocomplete="off">                                     
                             </div>

                            <div class="form-group col-lg-2">
                                <input type="text" name="srch_tdate" id="srch_tdate" class="form-control mydatepicker" placeholder="To Date"  autocomplete="off">                                     
                            </div>                            
                        </div>
                        <div class="row">
                        	<div class="col-md-12 text-right">
								...
								<a type="button" target="_blank" class="mb-xs mt-xs mr-xs btn btn-warning" title="Search" onclick="printDiv('print_div')"><i class="fa fa-print"></i></a> 
