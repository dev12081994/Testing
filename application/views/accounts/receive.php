<section role="main" class="content-body">
	...
	<div class="modal zoom-anim-dialog" data-backdrop="static" id="addReceive_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="col-md-12">
			...
			<section class="panel">
				...
				<div class="panel-body">
				 	<form method="post" id="srchpurchase_form" action="<?php echo base_url(); ?>REPORTS/exportReceive">    
						...
						<div class="alert <?php echo $alert_type; if($msg==='')echo ' hide'; ?>">
						 ...
						 <div class="row form-group">
                            ...
                            <div class="col-md-4 text-right">
								<button type="button" class="mb-xs mt-xs mr-xs btn btn-info reload-table" title="Search" onclick="srchReceive()"><i class="fa fa-search"></i></button> 
								<a class="mb-xs mt-xs mr-xs btn btn-primary pull-right" data-toggle="modal" data-original-title="Add New Member" data-placement="top" href="<?php echo base_url() ?>ACCOUNTS/addReceive"><i class="fa fa-plus"></i></a>
                   	...
                   	<div class="row" id="print_div">
                   		<div class="col-md-12" id="print_head" style="display:none;">
                   			<center><h1>Received Amount Report</h1></center>
                   		</div>
                   		<div class="col-md-12">
							<div class="table-responsive">
								<table class="table table-bordered table-striped table-condensed mb-none">
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/javascripts/views/accounts/receive.js"></script>