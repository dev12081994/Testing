...
<section role="main" class="content-body">
	<header class="page-header">
		<h2>Add/Update Receive Details</h2>
		...
		<div class="col-md-12">
			...
			<section class="panel">
				<header class="panel-heading hide">
					...
					<h2 class="panel-title">Receive Details </h2>
				</header>
				...
				<div class="panel-body">
					...
					<form method="post" id="payment_form" enctype="multipart/form-data" class="form-horizontal" action="<?php echo base_url() ?>ACCOUNTS/saveReceive">
						<div class="modal-body">
							<h4>Enter Receive Details :</h4>
							...
							<div class="form-group row">
								...
								<div class="col-sm-3">
									...
									<select data-plugin-selectTwo class="form-control " id="member_type" name="member_type" onchange="fetchMembers()" required>
                                        <option value="">Select Type</option>
                                        <option value="1" <?php if(isset($voch['acc_vochfor']) && $voch['acc_vochfor']==='1')echo 'selected'; ?>>Customer</option>
                                        <option value="2" <?php if(isset($voch['acc_vochfor']) && $voch['acc_vochfor']==='2')echo 'selected'; ?>>Vendor</option>
                                        <option value="3" <?php if(isset($voch['acc_vochfor']) && $voch['acc_vochfor']==='3')echo 'selected'; ?>>Employee</option>
                                        <option value="4" <?php if(isset($voch['acc_vochfor']) && $voch['acc_vochfor']==='6')echo 'selected'; ?>>Other</option>
                                    </select>
									
								</div>

								<div class="col-sm-3">
									<label class="control-label">Receive From<span class="required">*</span></label>
