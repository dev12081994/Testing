		...
		<div class="col-md-12">
			...
			<section class="panel">
				<header class="panel-heading hide">
					...
					<h2 class="panel-title">Sales Detail </h2>
				</header>
				<div class="panel-body">
				 	<form method="post" id="srchsale_form" action="<?php echo base_url(); ?>ADMIN001/exportCusCsv">                               
                        <div class="row">
                        ...
                        <div class="row">
                        	...
                        	<div class="col-md-2 text-right">
								<button type="button" class="mb-xs mt-xs mr-xs btn btn-info reload-table" title="Search" onclick="srchSale()"><i class="fa fa-search"></i></button> 
								<a class="mb-xs mt-xs mr-xs btn btn-primary pull-right" data-toggle="tooltip" data-original-title="Add New Member" data-placement="top" href="<?php echo base_url() ?>INVENTORY/addSalesBill"><i class="fa fa-plus"></i></a>
							</div>
                        </div>
                   	</form>
						...
						<table class="table table-bordered table-striped table-condensed mb-none">
							<thead>
								<tr>
                                    ...
                                    <th>Sattle Bill</th>
                                    <th class="h">History</th>                                     
                                    <th class="h">View</th>  
                                    <th class="h">Bill</th>  
                                    <th class="h">GST-Bill</th>  
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/javascripts/views/inventory/sale.js"></script>