...
<section role="main" class="content-body">
	<header class="page-header">
		<h2>Add/Update Purchase Invoice</h2>
		...
		<div class="col-md-12">
						...
						<form method="post" id="add_member_form" class="form-horizontal">
							<div class="modal-body">
								<div class="form-group">
									<label class="col-sm-3 control-label">Members Type<span class="required">*</span></label>
									<div class="col-sm-9">
			...
			<section class="panel">
				...
				<div class="panel-body">
					...
					<form method="post" id="add_prod_form" class="form-horizontal" enctype="multipart/form-data" action="<?php echo base_url() ?>INVENTORY/savePurchaseBill">
						<div class="modal-body">
							...
							<div class="form-group row">
								...
								<div class="col-lg-3">
	                                ...
	                                <input type="text" name="inv_billno" id="inv_billno" placeholder="Enter Invoice Number" class="form-control" required="true" autocomplete="off">
	                            </div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-3">									
									...
									<div class="input-group">										
	                    				<select data-plugin-selectTwo class="form-control" id="inv_perticular" name="inv_perticular"  required>
	                                        ...
	                                        <?php foreach ($vendor_data as $key => $value) { echo "<option value='".$value['c_id']."'>".ucwords(strtolower($value['vendor']))."</option>";
										} ?>
	                                    </select>
								...
								<div class="col-sm-3">
									<label class="control-label">Upload Invoice<span class="required">*</span></label>
									<input type="file" class="form-control" id="inv_docs" name="inv_docs">
								</div>							
									...
									<table class="table table-bordered table-striped table-condensed mb-none" width="100%">
										<thead>
											...
											<tr>
			                                    ...
			                                    <th width="50%">
			                                    	<span style="float:right;padding-right: 10;" id="subtot">0</span>
			                                    </th>
											</tr>
											<tr>
...
<script type="text/javascript" src="<?php echo base_url(); ?>assets/javascripts/views/inventory/add_purchasebill.js"></script>