<?php
	...
	$user_identity=$this->session->userdata['identity'];
	$user_role=$this->session->userdata['group_name'];
?>
...
<html class="fixed">
	<head>
		...
		<script src="<?php echo base_url(); ?>assets/javascripts/angular.min.js"></script>
				...
				<div class="header-right">
					...
					<div id="userbox" class="userbox pull-right">
						<a href="#" data-toggle="dropdown">
							...
							<div class="profile-info" data-lock-name="John Doe" data-lock-email="<?php echo $user_email ?>">
								<span class="name"><?php echo $user_identity; ?></span>
								<span class="role"><?php echo ucwords(strtolower($user_role)); ?></span>
							</div>
						...
						<div class="dropdown-menu">
							<ul class="list-unstyled">
								...
								<li>
									<a role="menuitem" tabindex="-1" href="<?php echo base_url(); ?>auth/logout"><i class="fa fa-power-off"></i> Logout</a>
								</li>
							</ul>
						</div>
					</div>
