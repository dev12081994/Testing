...
<section role="main" class="content-body">
				...
				<form method="post" id="add_cat_form" class="form-horizontal">
					<div class="modal-body">
						<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="text" id="c_name" name="c_name" class="form-control" placeholder="Enter Category Name..." required/>
								<input type="hidden" id="c_id" name="c_id" class="form-control" placeholder="Category Id..." readonly/>
								<input type="hidden" id="c_for" name="c_for" value="1" placeholder="Category..." readonly/>
							</div>
						</div>
						<div class="form-group">	
	...
	<section class="panel">
		...
		<div class="panel-body">
			<div class="row">
				<div class="col-md-3">
					<input type="text" class="form-control" placeholder="Search By Category" id="srch_cat"> 
					<input type="hidden" class="form-control" placeholder="Search For Category" id="srch_cfor" value="1"> 
				</div>
