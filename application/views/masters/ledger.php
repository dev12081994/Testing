...
<section role="main" class="content-body">
				...
				<form method="post" id="add_cat_form" class="form-horizontal">
					<div class="modal-body">
						<div class="form-group">
							<label class="col-sm-3 control-label">Ledger Name<span class="required">*</span></label>
							<div class="col-sm-9">
								...
								<input type="hidden" id="c_for" name="c_for" value="2" placeholder="Ledger Id..." readonly/>
							</div>
						</div>
						<div class="form-group">	
	...
	<section class="panel">
		<header class="panel-heading">
			...
			<h2 class="panel-title">Ledger Details </h2>
		</header>
		<div class="panel-body">
			<div class="row">
				<div class="col-md-3">
					<input type="text" class="form-control" placeholder="Search By Ledger" id="srch_cat"> 
					<input type="hidden" class="form-control" placeholder="Search For Ledger" value="2" id="srch_cfor"> 
				</div>
