			...
			<header class="clearfix">
				<div class="row">
					<div class="col-sm-6 mt-md">
						<h2 class="h3 mt-none mb-sm text-dark text-bold">INVOICE - <?php echo $value['inv_billno']; ?></h2>
					</div>
						...
						<table class="table h5 text-dark" width="30%" align="right">
							<tbody>
								<tr class="b-top-none">
									...
									<td class="text-right" style="padding-right:6% !important;"><?php echo $sub_total; ?></td>
								</tr>
								<tr>
									<td colspan="2">Discount</td>
									<td class="text-right" style="padding-right:6% !important;"><?php echo $tot_disc; ?></td>
								</tr>

								<?php if($transportation >0 ){ ?>
								<tr>
									<td colspan="2">Transportation Charge</td>
									<td class="text-right" style="padding-right:6% !important;"><?php echo $transportation; ?></td>
								</tr>
								<?php }
								...
								<tr>
									...
									<td class="text-right" style="padding-right:6% !important;"><?php echo $inv_roundoff; ?></td>
								</tr>
								<?php } ?>

								<tr class="h5 text-dark">
									<td colspan="2" style="font-weight:bold;">Grand Total</td>
									<td class="text-right" style="font-weight:bold;padding-right:6% !important;"><?php echo $sub_total-$tot_disc+$transportation+$inv_roundoff; ?></td>
								</tr>
							</tbody>
						</table>
					</div>
